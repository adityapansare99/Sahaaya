...
import { Upload, User, MapPin, Hash, Phone, Mail, Lock, Truck, FileText, Shield, CheckCircle, Heart, Star, Sparkles, Bike } from "lucide-react";
        ...
        <div className="w-full md:col-span-3 md:flex items-center justify-center min-h-[50vh] md:min-h-screen hidden bg-gradient-to-br from-red-50/30 via-white to-red-50/20 relative">
          ...
          <div className="text-center fixed top-[40vh] h-screen z-10 px-8">
            ...
            <div className="mt-8 space-y-3">
              <h2 className="text-2xl font-light text-gray-800 tracking-wide">Join <span className="font-bold text-red-500">Sahaaya</span></h2>
              <p className="text-gray-600 font-light leading-relaxed max-w-sm mx-auto">Become a delivery partner and help serve communities</p>
        ...
        <div className="flex md:mx-10 md:px-10 mx-4 md:col-span-4 my-6 md:my-8 flex-col items-center relative">
          <div className="w-full bg-white/95 backdrop-blur-sm md:px-15 px-6 md:py-12 py-8 shadow-2xl rounded-3xl border border-gray-100/80 relative overflow-hidden">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-red-500 mb-2 tracking-tight">Delivery Partner Registration</h1>
              <div className="w-20 h-1 bg-gradient-to-r from-red-500 to-red-400 mx-auto rounded-full mb-3"></div>
              <p className="text-gray-700 font-light leading-relaxed">Join our network of trusted delivery partners</p>
            </div>
            ...
            >
              ...
              <span className="relative flex items-center justify-center space-x-3">
                ...
                <span className="tracking-wide">Register as Delivery Partner</span>
              </span>
            </button>
