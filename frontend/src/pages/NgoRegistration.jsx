...
const NgoRegistration = () => {
  ...
  const [typeofNgo, settypeofNgo] = useState("Trust");
  ...
  const submitHandler = async () => {
    ...
    const response = await axios.post(`${backendurl}ngo/register`, formData);
          ...
          <div className="text-center fixed top-[40vh] h-screen z-10 px-8">
            ...
            <div className="mt-8 space-y-3">
              ...
              <p className="text-gray-600 font-light leading-relaxed max-w-sm mx-auto">
                Empowering communities through meaningful collaboration
              </p>
